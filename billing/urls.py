...
path('invoices/reporte-iva/', views.iva_report, name='iva_report'),
path('invoices/reporte-iva/pdf/', views.iva_report_pdf, name='iva_report_pdf'),
path('invoices/reporte-iva/excel/', views.iva_report_excel, name='iva_report_excel'),
